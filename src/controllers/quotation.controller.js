...
const rejectQuotation = async (req, res) => {
  try {
    ...
    // Update only the status field to "Rejected"
    const updatedQuotation = await Quotation.findByIdAndUpdate(
      quotationId,
      { status: "rejected" }, // only update this field
...
// ✅ Get Quotations of Mechanic
const getQuotationByMechanic = async (req, res) => {
  try {
...
export { createQuotation, getQuotationsBySupplier, approveQuotation, rejectQuotation, getQuotationByMechanic };